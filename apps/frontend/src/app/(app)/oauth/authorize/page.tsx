    ...
    return (
      <div className="flex flex-1 items-center justify-center text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-[20%] left-[10%] w-[300px] h-[300px] bg-primary rounded-full blur-[120px]" />
      ...
      <div className="flex flex-1 items-center justify-center text-white relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="w-[80px] h-[80px] mx-auto mb-[24px] rounded-full bg-red-500/20 flex items-center justify-center">
            <X className="w-[40px] h-[40px] text-red-500" />
          </div>
        ...
        <div className="bg-[#1A1919] rounded-[16px] p-[32px] flex flex-col gap-[24px]">
          ...
          <div className="flex gap-[12px]">
            <button
              ...
              disabled={submitting}
              className="flex-1 bg-primary hover:bg-primary/90 disabled:opacity-50 text-white rounded-[8px] py-[10px] px-[16px] text-[14px] font-semibold transition-colors"
            >
              Authorize
            </button>
            <button
