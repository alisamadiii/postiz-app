...
const ConnectedComponent: FC<{
  ...
  return (
    <div className="my-[16px] mt-[16px] h-[90px] bg-muted border-border border rounded-[4px] p-[24px]">
...
const ConnectComponent: FC<{
  ...
  return (
    <div className="my-[16px] mt-[16px] h-[100px] bg-muted border-border border rounded-[4px] px-[24px] flex">
