...
export const AnalyticsComponent: FC = () => {
  ...
  return (
    <div className="flex gap-[24px] flex-1">
      ...
      {/*<div className="w-[318px] bg-secondary mt-[-44px] p-[16px]">*/}
      ...
      {/*            <div className="self-stretch justify-start items-start gap-2.5 inline-flex pb-[16.5px] border-b-[1px] border-border">*/}
      {/*                <img className="w-8 h-8 rounded-full" src="https://via.placeholder.com/32x32"/>*/}
      {/*                <div className="grow shrink basis-0 flex-col justify-start items-start gap-1 inline-flex">*/}
      {/*                    <div className="justify-center items-center gap-1 inline-flex">*/}
      {/*                        <div className="text-foreground text-sm font-medium leading-tight">Nevo David</div>*/}
      ...
      {/*                        <div className="text-muted-foreground text-xs font-normal">See Tweet</div>*/}
