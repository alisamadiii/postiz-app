  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 24 24"
        fill="none"
        className="text-muted-foreground group-hover/profile:text-foreground"
      >
        <path
      ...
      {show && (
        <div
          ...
          className={`fixed p-[12px] bg-card shadow-menu flex flex-col gap-[16px] z-[100] rounded-[8px] border border-border text-nowrap`}
        >
