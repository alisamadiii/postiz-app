    ...
    <div className="relative w-full max-w-[400px] mx-auto">
      ...
      <div className="bg-card rounded-[12px] p-[20px] border border-border">
        <div className="text-[15px] font-semibold mb-[16px] flex items-center gap-[8px]">
          <DelayIcon size={18} className="text-primary" />
        ...
        <div className="flex gap-[12px] items-end">
          ...
          <button
            type="button"
            onClick={addHour}
            className="h-[42px] px-[16px] bg-primary hover:bg-primary/90 transition-colors rounded-[8px] flex items-center gap-[6px] text-white text-[14px] font-medium"
          >
            <PlusIcon size={14} />
            {t('add', 'Add')}
          </button>
